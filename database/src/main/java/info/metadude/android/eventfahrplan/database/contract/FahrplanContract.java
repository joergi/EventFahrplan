...
public interface FahrplanContract {
    ...
    interface SessionsTable {
        ...
        interface Columns extends BaseColumns {
            ...
            /* 15 */ String DATE = "date";
            /* 16 */ String LINKS = "links";
            /* 17 */ String DATE_UTC = "date_utc";
            /* 18 */ String ROOM_IDX = "room_idx";
            /* 19 */ String REC_LICENSE = "rec_license";
            /* 20 */ String REC_OPTOUT = "rec_optout";
            /* 21 */ String SLUG = "slug";
            /* 22 */ String URL = "url";
            /* 23 */ String CHANGED_TITLE = "changed_title";
            /* 24 */ String CHANGED_SUBTITLE = "changed_subtitle";
            /* 25 */ String CHANGED_ROOM = "changed_room";
            /* 26 */ String CHANGED_DAY = "changed_day";
            /* 27 */ String CHANGED_SPEAKERS = "changed_speakers";
            /* 28 */ String CHANGED_RECORDING_OPTOUT = "changed_recording_optout";
            /* 29 */ String CHANGED_LANGUAGE = "changed_language";
            /* 30 */ String CHANGED_TRACK = "changed_track";
            /* 31 */ String CHANGED_IS_NEW = "changed_is_new";
            /* 32 */ String CHANGED_TIME = "changed_time";
            /* 33 */ String CHANGED_DURATION = "changed_duration";
            /* 34 */ String CHANGED_IS_CANCELED = "changed_is_canceled";
        }
